...
export const topNavMenuConfig: any = {
  audio: {
  ...
  more: [
    ...
    {
      title: 'Volunteer',
      url: '/about/volunteerpositions.php',
    },
    {
      title: 'People',
      url: '/about/bios.php',
  ...
  web: {
    ...
    browserExtensionsLinks: [
      {
        url:
          'https://chrome.google.com/webstore/detail/save-to-the-wayback-machi/eebpioaailbjojmdbmlpomfgijnlcemk?hl=en',
        title: 'Chrome',
        external: true,
      },
      {
  ...
  user: [
    ...
    {
      url: '/details/@jasonb-sf',
      title: 'My library',
      analyticsEvent: 'UserLibrary',
    },
    {
      url: '/details/@jasonb-sf?tab=loans',
      title: 'My loans',
      analyticsEvent: 'UserLoans',
    },
    {
      url: '/details/fav-jasonb-sf',
      title: 'My favorites',
      analyticsEvent: 'UserFavorites',
    },
    {
      url: '/details/%40jasonb-sf/web-archive',
